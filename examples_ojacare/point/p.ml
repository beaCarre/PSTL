        ...
        object (self)
          method eq =
            fun (_p0 : jPoint) ->
              ...
              in
                Java.call "mypack.Point.eq(mypack.Point):boolean" jni_ref
                  [| _p0 |]
          method distance =
            fun () ->
              Int64.to_int
                (Java.call "mypack.Point.distance():long" jni_ref [|  |])
          method display =
            fun _p0 ->
          ...
          method rmoveto =
            fun _p0 _p1 ->
              ...
              in
                Java.call "mypack.Point.rmoveto(int,int):void" jni_ref
                  [| _p0; _p1 |]
          method moveto =
            fun _p0 _p1 ->
              let _p1 = Int32.of_int _p1 in
              let _p0 = Int32.of_int _p0
              in
                Java.call "mypack.Point.moveto(int,int):void" jni_ref
                  [| _p0; _p1 |]
          method set_y =
            fun _p ->
              let _p = Int32.of_int _p in Java.set_int_field jni_ref _p
          method get_y = fun () -> Java.get_int_field jni_ref __fid_y
          method set_x =
            fun _p ->
              let _p = Int32.of_int _p in Java.set_int_field jni_ref _p
          method get_x = fun () -> Java.get_int_field jni_ref __fid_x
            ...
            object (self)
              method eq_colored_point =
                fun (_p0 : jColoredPoint) ->
                  ...
                  in
                    Java.call
                      "mypack.ColoredPoint.eq(mypack.ColoredPoint):boolean"
                      jni_ref [| _p0 |]
              method setColor =
                fun _p0 ->
                  let _p0 = JavaString.of_string _p0
                  in
                    Java.call
                      "mypack.Colored.setColor(java.lang.String):void"
                      jni_ref [| _p0 |]
              method getColor =
                fun () ->
                  JavaString.to_string
              ...
              method display =
                fun _p0 ->
                  let _p0 = Int64.of_int _p0
                  in
                    Java.call "mypack.Point.display(long):int" jni_ref
                      [| _p0 |]
              method toString =
                fun () ->
                  JavaString.to_string
...
let mypack_jPoint__main =
  let clazz = Jni.find_class "mypack/Point" in
  let id =
    try Jni.get_static_methodID clazz "main" "([java.lang.String):void"
    with
    | _ ->
        failwith
